            ...
            Text(
              text = if (isPlayStoreBuild) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                  "mpvNext requires \"Photos and videos\" permission to access and play your video files stored on your device."
                } else {
                  "mpvNext requires \"Storage\" permission to access and play your media files stored on your device."
                }
              } else {
                "mpvNext requires \"All file access\" permission to discover media and subtitles on your device due to a change in security policy in Android 11 and later versions."
              },
      ...
      text = {
        Column(
          ...
          if (isPlayStoreBuild) {
            ...
            Text(
              text = "mpvNext needs access to your video files to provide its core functionality as a media player.",
              style = MaterialTheme.typography.bodyMedium,
            ...
            Text(
              text = "mpvNext has always required storage access permission as it's essential for the app to find all media and subtitle files on your device, including the ones that are not supported by the system.",
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          ...
          Text(
            text = "mpvNext is an open source project. You can review the source code and verify how permissions are used by visiting our GitHub repository at:",
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
